-- ============================================
-- PRISON RP ULTRA V70 (ОБХОД АНТИЧИТА)
-- by shasik_1488 | РАБОТАЕТ В PRISON RP
-- ============================================
...
pcall(function()
    for _, v in pairs(game:GetDescendants()) do
        if v:IsA("Script") or v:IsA("LocalScript") then
            if v.Name:lower():find("anticheat") or v.Name:lower():find("anti") or v.Name:lower():find("detect") or v.Name:lower():find("cheat") or v.Name:lower():find("security") or v.Name:lower():find("exploit") then
                v.Disabled = true
            end
        end
...
function getClosestTarget()
    if not states.silentAim then return nil end
    local closest = nil
    ...
    for _, p in pairs(game.Players:GetPlayers()) do
        if p ~= player and p.Character and p.Character:FindFirstChild("HumanoidRootPart") then
            ...
            local targetPart = tChar:FindFirstChild(aimPart) or tChar:FindFirstChild("Head")
...
function reconnectAfterDeath()
    ...
    if states.silentAim then toggleSilentAim() end
...
function toggleSilentAim()
    ...
    if states.silentAim then
        if silentBtn then
            ...
            silentBtn.TextColor3 = Color3.fromRGB(0, 255, 100)
            silentBtn.BorderColor3 = Color3.fromRGB(0, 255, 100)
        end
        notify("Silent Aim", true)
    else
        if silentBtn then
            silentBtn.Text = "🎯 Silent Aim    [❍⊃]"
            silentBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
            silentBtn.BorderColor3 = Color3.fromRGB(0, 150, 255)
        end
        notify("Silent Aim", false)
    end
end

function updateFov(value)
    settings.silentFov = math.clamp(value, 10, 300)
    if fovSliderLabel then
        fovSliderLabel.Text = "FOV: " .. math.floor(settings.silentFov)
    end
    if fovSliderFill then
        fovSliderFill.Size = UDim2.new((settings.silentFov - 10) / 290, 0, 1, 0)
    end
    fovCircle.Radius = settings.silentFov
    saveSettings()
end
...
frame.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(8, 8, 20) or Color3.fromRGB(240, 240, 255)
frame.BackgroundTransparency = 0.1
frame.Active = true
frame.Draggable = true
frame.ClipsDescendants = true
frame.BorderSizePixel = 2
frame.BorderColor3 = settings.theme == "dark" and Color3.fromRGB(0, 200, 255) or Color3.fromRGB(100, 100, 200)
frame.ZIndex = 5
...
line.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(255, 200, 0) or Color3.fromRGB(100, 100, 200)
...
categoryFrame.Position = UDim2.new(0.05, 0, 0, 82)
...
for i, cat in ipairs(categories) do
    ...
    btn.MouseEnter:Connect(function()
        if btn.TextColor3 ~= (settings.theme == "dark" and Color3.fromRGB(255, 200, 0) or Color3.fromRGB(0, 0, 150)) then
            btn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end
    end)
    btn.MouseLeave:Connect(function()
        if btn.TextColor3 ~= (settings.theme == "dark" and Color3.fromRGB(255, 200, 0) or Color3.fromRGB(0, 0, 150)) then
...
local noclipBtn, espBtn, aimBtn, silentBtn, invBtn, tpBtn
local fovSliderFrame, fovSliderLabel, fovSliderFill
local espNameBtn, espDistBtn, colorBtn, sizeBtn, transBtn, distBtn, themeBtn
...
function updateContent()
    ...
    if currentCategory == 1 then -- Главная
        ...
        speedBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        speedBtn.MouseEnter:Connect(function()
            speedBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        jumpBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        jumpBtn.MouseEnter:Connect(function()
            jumpBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        jumpSliderFrame.Size = UDim2.new(1, 0, 0, 48)
        ...
        jumpSliderLabel.Size = UDim2.new(1, 0, 0, 20)
        jumpSliderLabel.Text = "Высота прыжка: " .. math.floor(settings.jumpPower)
        ...
        jumpSliderBg.Size = UDim2.new(1, 0, 0, 10)
        jumpSliderBg.Position = UDim2.new(0, 0, 0, 26)
        ...
        noclipBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        noclipBtn.MouseEnter:Connect(function()
            noclipBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        flyBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        flyBtn.MouseEnter:Connect(function()
            flyBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        flySliderFrame.Size = UDim2.new(1, 0, 0, 48)
        ...
        flySliderLabel.Size = UDim2.new(1, 0, 0, 20)
        flySliderLabel.Text = "Скорость Fly: " .. math.floor(settings.flySpeed)
        ...
        flySliderBg.Size = UDim2.new(1, 0, 0, 10)
        flySliderBg.Position = UDim2.new(0, 0, 0, 26)
        ...
        invBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        invBtn.MouseEnter:Connect(function()
            invBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        tpBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        tpBtn.MouseEnter:Connect(function()
            tpBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
    ...
    elseif currentCategory == 2 then -- Бой
        ...
        aimBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        aimBtn.MouseEnter:Connect(function()
            aimBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        -- Silent Aim
        silentBtn = Instance.new("TextButton", contentFrame)
        silentBtn.Size = UDim2.new(1, 0, 0, 38)
        silentBtn.Text = states.silentAim and "🎯 Silent Aim    [⊂❍]" or "🎯 Silent Aim    [❍⊃]"
        silentBtn.TextColor3 = states.silentAim and Color3.fromRGB(0, 255, 100) or (settings.theme == "dark" and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(0, 0, 0))
        silentBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        silentBtn.BackgroundTransparency = 0.2
        silentBtn.Font = Enum.Font.SourceSansBold
        silentBtn.TextSize = 15
        silentBtn.BorderSizePixel = 1
        silentBtn.BorderColor3 = states.silentAim and Color3.fromRGB(0, 255, 100) or (settings.theme == "dark" and Color3.fromRGB(0, 150, 255) or Color3.fromRGB(100, 100, 200))
        silentBtn.ZIndex = 10
        Instance.new("UICorner", silentBtn).CornerRadius = UDim.new(0.1, 0)
        
        silentBtn.MouseEnter:Connect(function()
            silentBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        silentBtn.MouseLeave:Connect(function()
            silentBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        end)
        ...
        -- FOV ползунок
        fovSliderFrame = Instance.new("Frame", contentFrame)
        fovSliderFrame.Size = UDim2.new(1, 0, 0, 48)
        fovSliderFrame.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(15, 15, 35) or Color3.fromRGB(210, 210, 235)
        fovSliderFrame.BackgroundTransparency = 0.3
        fovSliderFrame.BorderSizePixel = 1
        fovSliderFrame.BorderColor3 = settings.theme == "dark" and Color3.fromRGB(0, 150, 255) or Color3.fromRGB(100, 100, 200)
        fovSliderFrame.ZIndex = 10
        Instance.new("UICorner", fovSliderFrame).CornerRadius = UDim.new(0.1, 0)
        
        fovSliderLabel = Instance.new("TextLabel", fovSliderFrame)
        fovSliderLabel.Size = UDim2.new(1, 0, 0, 20)
        fovSliderLabel.Text = "FOV: " .. math.floor(settings.silentFov)
        fovSliderLabel.TextColor3 = settings.theme == "dark" and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(0, 0, 0)
        fovSliderLabel.BackgroundTransparency = 1
        fovSliderLabel.Font = Enum.Font.SourceSansBold
        fovSliderLabel.TextSize = 14
        fovSliderLabel.ZIndex = 10
        
        local fovSliderBg = Instance.new("Frame", fovSliderFrame)
        fovSliderBg.Size = UDim2.new(1, 0, 0, 10)
        fovSliderBg.Position = UDim2.new(0, 0, 0, 26)
        fovSliderBg.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(30, 30, 60) or Color3.fromRGB(180, 180, 210)
        fovSliderBg.BorderSizePixel = 0
        fovSliderBg.ZIndex = 10
        Instance.new("UICorner", fovSliderBg).CornerRadius = UDim.new(0.2, 0)
        
        fovSliderFill = Instance.new("Frame", fovSliderBg)
        fovSliderFill.Size = UDim2.new((settings.silentFov - 10) / 290, 0, 1, 0)
        fovSliderFill.BackgroundColor3 = Color3.fromRGB(255, 200, 0)
        fovSliderFill.BorderSizePixel = 0
        fovSliderFill.ZIndex = 10
        Instance.new("UICorner", fovSliderFill).CornerRadius = UDim.new(0.2, 0)
        
        local dragFov = false
        fovSliderBg.InputBegan:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                dragFov = true
                local pos = input.Position.X - fovSliderBg.AbsolutePosition.X
                local value = math.clamp(pos / fovSliderBg.AbsoluteSize.X, 0, 1) * 290 + 10
                settings.silentFov = math.floor(value)
                fovSliderLabel.Text = "FOV: " .. settings.silentFov
                fovSliderFill.Size = UDim2.new((settings.silentFov - 10) / 290, 0, 1, 0)
                fovCircle.Radius = settings.silentFov
                saveSettings()
            end
        ...
        fovSliderBg.InputChanged:Connect(function(input)
            if dragFov and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
                local pos = input.Position.X - fovSliderBg.AbsolutePosition.X
                local value = math.clamp(pos / fovSliderBg.AbsoluteSize.X, 0, 1) * 290 + 10
                settings.silentFov = math.floor(value)
                fovSliderLabel.Text = "FOV: " .. settings.silentFov
    ...
    elseif currentCategory == 3 then -- ESP
        ...
        espBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        espBtn.MouseEnter:Connect(function()
            espBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        espNameBtn.Size = UDim2.new(1, 0, 0, 38)
        espNameBtn.Text = states.espName and "👤 Имя    [⊂❍]" or "👤 Имя    [❍⊃]"
        ...
        espNameBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        espNameBtn.MouseEnter:Connect(function()
            espNameBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        espDistBtn.Size = UDim2.new(1, 0, 0, 38)
        espDistBtn.Text = states.espDistance and "📏 Дистанция    [⊂❍]" or "📏 Дистанция    [❍⊃]"
        ...
        espDistBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        espDistBtn.MouseEnter:Connect(function()
            espDistBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
    ...
    elseif currentCategory == 4 then -- Настройки
        ...
        colorBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        colorBtn.MouseEnter:Connect(function()
            colorBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        sizeBtn.Size = UDim2.new(1, 0, 0, 38)
        ...
        sizeBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        sizeBtn.MouseEnter:Connect(function()
            sizeBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        transBtn.Size = UDim2.new(1, 0, 0, 38)
        ...
        transBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        transBtn.MouseEnter:Connect(function()
            transBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        distBtn.Size = UDim2.new(1, 0, 0, 38)
        ...
        distBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        distBtn.MouseEnter:Connect(function()
            distBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        themeBtn.Size = UDim2.new(1, 0, 0, 38)
        ...
        themeBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(20, 20, 45) or Color3.fromRGB(200, 200, 230)
        ...
        themeBtn.MouseEnter:Connect(function()
            themeBtn.BackgroundColor3 = settings.theme == "dark" and Color3.fromRGB(35, 35, 70) or Color3.fromRGB(180, 180, 220)
        end)
        ...
        -- Кнопка закрытия УБРАНА, как ты просил
    end
...
-- ============================================
local snowContainer = Instance.new("Frame", gui)
...
for i = 1, 350 do
    ...
    particle.BackgroundTransparency = 0.1 + math.random() * 0.25
...
iconShadow.Size = UDim2.new(1.2, 0, 1.2, 0)
iconShadow.Position = UDim2.new(-0.1, 0, -0.1, 0)
...
spawn(function()
    ...
    while true do
        ...
        iconBtn.Size = UDim2.new(0, 50 * scale, 0, 50 * scale)
        iconBtn.TextColor3 = Color3.new(1, 0.85 + pulse * 0.1, 0.2)
        glow.BackgroundTransparency = 0.85 - pulse * 0.05
        glow.Size = UDim2.new(1.25 + pulse * 0.08, 0, 1.25 + pulse * 0.08, 0)
...
iconBtn.InputChanged:Connect(function(input)
    if isDragging and (input.UserInputType == Enum.UserInputType.Touch or input.UserInputType == Enum.UserInputType.MouseMovement) then
        ...
        local newX = math.clamp(iconStartPos.X + delta.X / 1920, 0.01, 0.98)
        local newY = math.clamp(iconStartPos.Y + delta.Y / 1080, 0.01, 0.98)
...
print("✅ PRISON RP ULTRA V70 by shasik_1488 загружен!")
